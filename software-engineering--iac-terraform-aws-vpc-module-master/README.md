...
```hcl
module "vpc" {
  source  = "github.com/Iberia-Ent/software-engineering--iac-terraform-aws-vpc-module?ref=v3.11.0"
...
It is possible to integrate this VPC module with [terraform-aws-transit-gateway module](https://github.com/Iberia-Ent/software-engineering--iac-terraform-aws-transit-gateway-module) which handles the creation of TGW resources and VPC attachments. See [complete example there](https://github.com/Iberia-Ent/software-engineering--iac-terraform-aws-transit-gateway-module/tree/master/examples/complete).

## Examples

- [Simple VPC](https://github.com/Iberia-Ent/software-engineering--iac-terraform-aws-vpc-module/tree/v3.11.0/examples/simple-vpc)
- [Simple VPC with secondary CIDR blocks](https://github.com/Iberia-Ent/software-engineering--iac-terraform-aws-vpc-module/tree/v3.11.0/examples/secondary-cidr-blocks)
- [Complete VPC](https://github.com/Iberia-Ent/software-engineering--iac-terraform-aws-vpc-module/tree/v3.11.0/examples/complete-vpc) with VPC Endpoints.
- [VPC with IPv6 enabled](https://github.com/Iberia-Ent/software-engineering--iac-terraform-aws-vpc-module/tree/v3.11.0/examples/ipv6)
- [Network ACL](https://github.com/Iberia-Ent/software-engineering--iac-terraform-aws-vpc-module/tree/v3.11.0/examples/network-acls)
- [VPC Flow Logs](https://github.com/Iberia-Ent/software-engineering--iac-terraform-aws-vpc-module/tree/v3.11.0/examples/vpc-flow-logs)
- [VPC with Outpost](https://github.com/Iberia-Ent/software-engineering--iac-terraform-aws-vpc-module/tree/v3.11.0/examples/outpost)
- [Manage Default VPC](https://github.com/Iberia-Ent/software-engineering--iac-terraform-aws-vpc-module/tree/v3.11.0/examples/manage-default-vpc)
- [Few tests and edge case examples](https://github.com/Iberia-Ent/software-engineering--iac-terraform-aws-vpc-module/tree/v3.11.0/examples/issues)
